...
class CardPayHomeAdmin extends Component {
  ...
  retrievePosts() {
    axios.get("http://localhost:8080/cardposts").then(res => {
  ...
  //delete function 
  onDelete = (id) => {
    axios.delete(`http://localhost:8080/cardpost/delete/${id}`).then((res) => {
...
export default CardPayHomeAdmin;